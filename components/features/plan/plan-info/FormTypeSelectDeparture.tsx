...
export default function FormTypeSelectDeparture({
  ...
  return (
    <div>
      <h4 className='text-typo-base text-brand-gray-600 mt-10 mb-3'>목적지</h4>
        ...
        >
          ...
          >
            <input
              ...
              className='col-start-1 row-start-1 bg-transparent outline-none pr-6 truncate text-typo-base text-brand-gray-600'
            />
            <Icon
