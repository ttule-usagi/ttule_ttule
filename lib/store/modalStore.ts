 ...
 *
 * ModalType은 현재 'editLink', 'viewLink', 'enterInviteLink', 'confirm' 네 가지 타입이 정의되어 있으며, 필요에 따라 새로운 모달 타입을 추가할 수 있음
 */

type ModalType = 'editLink' | 'viewLink' | 'enterInviteLink' | 'confirm';
